...
class Rossmann(object):
    def __init__(self):
        self.home_path='C:/Users/kaka/Projetos_DS/store_sales_predict/'
    ...
    def data_cleaning(self, df1):
        colds_old = ['Store', 'DayOfWeek', 'Date', 'Open', 'Promo',
    ...
    def data_preparation(self, df5):
        ...
        cols_selected = ['store', 'promo', 'store_type', 'assortment', 'competition_distance',
                        ...
                        'day_of_week_cos', 'month_cos', 'month_sin', 'day_sin', 'day_cos', 'week_of_year_sin',
                        'week_of_year_cos']
